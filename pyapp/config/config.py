...
LastEditTime: 2024年12月23日20:08:29
Description: 配置文件
usage:
...
class Config:
    ...
    ##
    appName = 'kgnix'  # 应用名称
    appNameEN = 'kgnix'    # 应用名称-英文（用于生成缓存文件夹，必须是英文）
    appVersion = "V1.0.0"  # 应用版本号
    appDeveloper = "sinvon"  # 应用开发者
    appBlogs = "https://github.com/isinvon"  # 个人博客
    appPackage = 'sinvon'    # 应用包名，用于在本地电脑生成 sinvon 唯一文件夹
    appUpdateUrl = 'https://api.github.com/repos/isinvon/kgnix/releases/latest'    # 获取程序更新信息 https://api.github.com/repos/pangao1990/ppx/releases/latest
